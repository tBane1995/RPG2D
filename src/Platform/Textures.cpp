...
void loadTextures()
{
	...
	loadSingleTexture("GUI/character_menu/menu_statistics.png", 28, 20);
	loadSingleTexture("GUI/character_menu/menu_layout.png", 28, 20);
	loadSingleTexture("GUI/character_menu/menu_equipment.png", 28, 20);
	loadSingleTexture("GUI/character_menu/menu_inventory.png", 28, 20);
	loadSingleTexture("GUI/character_menu/menu_dialogues.png", 28, 20);
	loadSingleTexture("GUI/character_menu/menu_quests.png", 28, 20);
