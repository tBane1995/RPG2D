...
public:
	...
	ControlsPanel() {
        ...
        up = sf::Sprite();
        up.setTexture(*getTexture("GUI/buttonArrowUp")->texture);
        up.setOrigin(20, 20);

        down = sf::Sprite() ;
        down.setTexture(*getTexture("GUI/buttonArrowDown")->texture);
        down.setOrigin(20, 20);

        left = sf::Sprite();
        left.setTexture(*getTexture("GUI/buttonArrowLeft")->texture);
        left.setOrigin(20, 20);

        right = sf::Sprite();
        right.setTexture(*getTexture("GUI/buttonArrowRight")->texture);
        right.setOrigin(20, 20);

        space = sf::Sprite();
        space.setTexture(*getTexture("GUI/space")->texture);
        space.setOrigin(80, 20);

        e = sf::Sprite();
        e.setTexture(*getTexture("GUI/button")->texture);
        e.setOrigin(20, 20);

        h = sf::Sprite();
        h.setTexture(*getTexture("GUI/button")->texture);
        h.setOrigin(20, 20);

        j = sf::Sprite();
        j.setTexture(*getTexture("GUI/button")->texture);
        j.setOrigin(20, 20);
